...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware(['auth:sanctum', 'tenant'])->group(function (): void {
        ...
        Route::get('staff/permissions', [TenantStaffController::class, 'permissions']);
        Route::get('staff/roles', [TenantStaffController::class, 'roles']);
        Route::post('staff/roles', [TenantStaffController::class, 'storeRole']);
        Route::patch('staff/roles/{role}', [TenantStaffController::class, 'updateRole']);
        Route::delete('staff/roles/{role}', [TenantStaffController::class, 'destroyRole']);
        Route::get('staff/users', [TenantStaffController::class, 'users']);
        Route::post('staff/users', [TenantStaffController::class, 'storeUser']);
        Route::patch('staff/users/{user}', [TenantStaffController::class, 'updateUser']);
        Route::delete('staff/users/{user}', [TenantStaffController::class, 'destroyUser']);
